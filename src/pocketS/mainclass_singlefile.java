...
public class mainclass_singlefile {
static int count=0;
	static int folderName=9; 
	// static {
	...
	public static void main(String args[]) {
		try
		{
			writer1 = new PrintWriter("D:\\WorkSpace_Studio\\Models\\Clustering\\files\\result"+(folderName+1)+".txt", "UTF-8");
